...
<head>
    ...
    <title>Food And Taste | Home Page</title>
     <!--Google font link-->
     <link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Berkshire+Swash&family=Raleway&display=swap" rel="stylesheet">
     <!--Stylesheet link-->
...
<?php include_once('includes/header.php');?>
        ...
        <section style="background-color: rgba(0, 0, 0, 0.7);">
          ...
          <source src="./video/pizza-123629.mp4" type="video/mp4">
      </video>
      
                </div>
                <div class="restaurant-searching style2 text-center" >
                    <div class="restaurant-searching-inner">
						<span style="font-family: 'Berkshire Swash', cursive;"> <span style="color: orange;">Welcome to</span> Food <span style="color: green;"> and Taste</span> </span>
...
<!------------------------------------ Restaurant Searching section start here ----------------------------------->
            </div>
        </section>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    //   food menu fetch from database table name = tblfood
  ...
  <a class="log-popup-btn btn  pull-right blue-bg brd-rd3 btn-danger" href="#" title="Login">Add to Cart</a>
<?php } else {?>
<button type="submit" name="addcart" class="btn  pull-right blue-bg brd-rd3 btn-danger">Add to Cart</button>
                                                <?php } ?>
                                        </form>
                                            </div>
                                        </div>
