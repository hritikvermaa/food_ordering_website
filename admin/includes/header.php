 <div class="row border-bottom">
        ...
        <div class="navbar-header">
            ...
            <a href="dashboard.php" title="Home" itemprop="url"><img src='https://i.postimg.cc/nLTRgSgd/logo1.png' border='0' alt='logo1' height="55px" width="55px" /></a>
        </div>
        
 <p style="font-size: 20px;padding-top:1%" ><strong>Food And Taste - Admin Panel</strong></p>
