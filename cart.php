...
$city=$_POST['city'];
$userid=$_SESSION['fosuid'];  // HERE ID (FOOD ORDERING SYSTEM ID) ARE FOREIGN KEY
//genrating order number
$orderno= mt_rand(100000000, 999999999);// RANDOM NUMBER GENERATOR
...
if(isset($_GET['delid'])) {
$rid=$_GET['delid'];
$query=mysqli_query($con,"delete from tblorders where ID='$rid'"); //database table order
                ...
                <div class="page-title-wrapper text-center">
					<div class="col-md-12 col-sm-12 col-lg-12">
						<div class="page-title-inner">
							<h1 itemprop="headline">My Cart</h1>
...
<tr>
     ...
     <th style="text-align:center;"><a href="online-payment.php?amount=<?php echo $grandtotal; ?>">pay online</a></th>
     <th></th>
</tr>
</thead>
<form method="post">
...
<tr>
    <td colspan="3">
       <button   type="submit" name="placeorder" class="btn theme-btn btn-lg btn-danger">Place order</button>
   </td></tr>
   </form>
